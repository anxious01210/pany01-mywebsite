<?php
	...
	if (fwrite($file, $emailAddress . PHP_EOL)) {
		...
		if (preg_match('/^[^@]+@[a-zA-Z0-9._-]+\.[a-zA-Z]+$/', trim($myEmail))) {
				...
				$message = 'The following person was kind enough to subscribe to your newsletter:' . PHP_EOL . $emailAddress;
				mail($emailAddress, 'You have a new newsletter subscriber', $message, $headers);
		}
